...
{
    public static class RequestHeplper
    {
        private const string ApiPath = "https://localhost:5001/api/";


        public static TObj GetNotAsync<TObj>(this TObj obj) where TObj : ModelAbstract
        {
