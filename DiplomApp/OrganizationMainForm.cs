...
namespace DiplomApp
{
    public partial class OrganizationMainForm : Form
    {
        ...
        private void OrganizationMainForm_Load(object sender, EventArgs e)
        {
        ...
        {
            RykovodOrgForm orgForm = new RykovodOrgForm(Global.userId);
            orgForm.Show();
            this.Close();
        }
    }
